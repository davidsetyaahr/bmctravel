...
Route::get('/tour-package/compare', 'frontend\TourPackage@compare');
Route::get('/tour-package/wishlist', 'frontend\TourPackage@wishlist');
...
Route::get('/my-account/wishlist', 'frontend\MyAccount@wishlist');
...
Route::post('/my-account/actchangepassword/', 'frontend\MyAccount@actchangepassword');
