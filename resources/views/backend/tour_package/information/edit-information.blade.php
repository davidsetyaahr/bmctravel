                ...
                @csrf
                    ...
                    <br>
                        ...
                        <select name="type" id="" class="form-control">
                            ...
                            <option value="0" {{ $inf->type == 0 ? 'selected' : '' }}>Termasuk</option>
                            <option value="1" {{ $inf->type == 1 ? 'selected' : '' }}>Tidak Termasuk</option>
                            <option value="2" {{ $inf->type == 3 ? 'selected' : '' }}>Apa yang harus aku siapkan?</option>
                        </select>
                    <br>
